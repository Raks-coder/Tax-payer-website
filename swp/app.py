...
def calculate():
	if request.method=='GET':
		...
		if(age<60 and income>=2.50 and income<5):
			...
			return ("""<head><link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.1.3/css/bootstrap.min.css" integrity="sha384-MCw98/SFnGE8fJT3GXwEOngsV7Zt27NXFoaoApmYm81iuXoPkFOJwJ8ERdknLPMO" crossorigin="anonymous"></head><body class="container jumbotron" style="background-color: silver"><h1>Tax to be Payed in rupees </h1></body>"""+tax+"""<div><h3>In order to proceed to the payment click here<h3></div><div><a href="https://onlineservices.tin.egov-nsdl.com/etaxnew/tdsnontds.jsp">Pay</a></div><h3>To return to website home page click here</h3><div><a href="/">Home</a></div>""")
...
def contact():
	if request.method=='GET': 	
		...
		return """<h1>We will get back to you within 24 hours!</h1><a href="/">To go back to home page click here</a>"""
